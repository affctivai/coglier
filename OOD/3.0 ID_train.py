...
parser.add_argument("--threshold", dest="threshold", type=float, action="store", default=0.90) # 0.98, 0.95, 0.90, 0.85
...
PROJECT = f'Ind_{int(THRESHOLD*100)}'
...
def run_test(model_name, train_path):
    ...
    model, max_lr = get_model_with_dropout(MODEL_NAME, testset.x.shape, len(labels_name), device, DROPOUT)
